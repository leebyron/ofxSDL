...
//--------------------------------------------------------------
void testApp::joyButtonPressed(int device, int button) {
  printf("joy pressed %i - %i\n", device, button);
}

//--------------------------------------------------------------
void testApp::joyButtonReleased(int device, int button) {
  printf("joy released %i - %i\n", device, button);
}

//--------------------------------------------------------------
void testApp::joyAxisMoved(int device, int axis, float position) {
  printf("joy moved %i - %i - %f\n", device, axis, position);
}
